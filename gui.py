...
class Gui:
    ...
    def shop_window(self):
        ...
        shop_inventory_text = tk.Label(self.shop_window_var,
                                       text=self.floor.room().encounter.shop_encounter.display_shop_inventory())
    ...
    def inventory(self):
        ...
        for item in self.player.inventory:
            ...
            match item.type:
                ...
                case default:
                    pass
            radio_button = tk.Radiobutton(self.inventory_window,
                                          text=f"{item.name}: {item.attributeValue}{attribute_name}",
                                          value=item.__str__(), variable=self.inventory_radio,
                                          command=lambda x=item: set_active(x))
